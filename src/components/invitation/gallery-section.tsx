...
export function GallerySection() {
  return <section className="invitation-section gallery-section" aria-labelledby="gallery-heading" data-reveal="section" data-gallery>
    <PetalField />
    ...
    <h2 id="gallery-heading" data-gallery-heading>Photo Gallery</h2>
